...
2. **Assign the next number.** Read the Rules index table in `CLAUDE.md`, find the
   highest `R#`, and use the next integer. The kit ships R1-R13 (R1-R8 mechanical
   core, R9-R11 plus R13 engineering disciplines, R12 file headers); a project's
   own rules continue from R14.
