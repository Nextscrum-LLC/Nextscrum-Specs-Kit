...
current tenant." The command assigns the next free number (R16, since the kit
ships R1 through R15), adds a row to the rules table in `CLAUDE.md`, and scaffolds
