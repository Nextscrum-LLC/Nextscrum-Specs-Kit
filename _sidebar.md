...
<!-- Docsify sidebar. Links are root-absolute so they resolve from any page. -->
...
- Reference
  ...
  - [Post-mortems](/docs/post-mortems/README.md)

- Worked example (SPEC-000)
  - [spec.md](/docs/specs/000-example-feature/spec.md)
  - [plan.md](/docs/specs/000-example-feature/plan.md)
  - [tasks.md](/docs/specs/000-example-feature/tasks.md)
  - [tests.md](/docs/specs/000-example-feature/tests.md)
